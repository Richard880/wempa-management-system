...
import aboutImage from "../../assets/images/about-maritime.jpg";
          ...
          <Col lg={6}>
            ...
            >
              ...
              <p className="section-description mt-4">
                The Western Kenya Maritime Professionals Association (WEMPA)
                is a professional organization committed to promoting
              ...
              <p className="section-description">
                ...
                officers, fishermen, logistics professionals, institutions
                and stakeholders to strengthen the blue economy and create
