          ...
          <Col lg={6}>
            ...
            >
              ...
              <h1 className="hero-title mt-4">
                Connecting{" "}
                <span className="text-warning">Maritime Professionals</span>{" "}
                Across Western Kenya
              </h1>

              <p className="hero-text mt-4">
                WEMPA brings together captains, marine engineers, maritime
                officers, fishermen, logistics professionals, students and
                stakeholders dedicated to strengthening the blue economy around
                Lake Victoria.
              </p>
